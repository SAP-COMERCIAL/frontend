  ...
  (self["webpackChunkmaterial"] = self["webpackChunkmaterial"] || []).push([["common"], {
        ...
        _createClass(_CustomerComponent, [{
          ...
          value: function getcustomer() {
            ...
            this._customerservice.getcustomerAll().subscribe(function (res) {
              ...
              _this.dataSourceShow = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__.MatTableDataSource(res);
              _this.array = res;
              _this.totalSize = _this.array.length;

              _this.iterator();

              _this.dataSourceShow.sort = _this.sort;
            }, function (error) {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _SupplierComponent.ɵfac = function SupplierComponent_Factory(t) {
        return new (t || _SupplierComponent)();
      };

      _SupplierComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
