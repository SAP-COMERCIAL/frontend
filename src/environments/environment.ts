...
export const environment = {
  production: false,
  urlapi : 'http://api.dev.comercial.gsctech.com.mx/', //'https://gsctech.azurewebsites.net/', //  'https://sap-comercial.azurewebsites.net/', // 'http://api.qas.comercial.gsctech.com.mx/', //'http://api.prod.comercial.gsctech.com.mx/'
