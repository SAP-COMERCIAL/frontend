...
export const environment = {
  production: false,
  urlapi : 'https://gsctech.azurewebsites.net/', // 'http://api.dev.comercial.gsctech.com.mx/', // 'https://sap-comercial.azurewebsites.net/', // 'http://api.qas.comercial.gsctech.com.mx/', //'http://api.prod.comercial.gsctech.com.mx/'
