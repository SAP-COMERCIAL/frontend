...
this.dialogRef.close();
  ...
  getsupplierDocuments(){
    ...
    arraySupplier.push({supplier_id : 1, documento : 'Reporte al IMSS y su acuse de presentacion ICSOE en PDF', estatus : 'Por Revisar', aprobacion : true}
                        , {supplier_id : 1, documento : 'Reporte al INFONAVIT y su acuse de presentacion SISUB en PDF', estatus : 'Por Revisar', aprobacion : true}
                      )
