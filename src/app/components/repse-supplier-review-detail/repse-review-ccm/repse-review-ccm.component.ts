...
@Component({
  ...
  templateUrl: './repse-review-ccm.component.html',
  styleUrls: ['./repse-review-ccm.component.css']
})
export class RepseReviewCcmComponent implements OnInit {
  ...
  getsupplierDocuments(){
    ...
    this._UploadFileService.getdocumentsAll().subscribe(
      res=> {
        ...
        arrayDocumentosFiltrados = arrayDocumentos.filter(e => e.idProveedor == this.providerId && e.categoriaDocumento > 500 && e.categoriaDocumento < 600 && e.anno == anio && e.mes == mes);

        this.dataSourceShow = null;
        this.arraySupplierGlobal = [];
        this.showDocument(arrayDocumentosFiltrados, 501, anio, mes, 'Orden de compra CCM');
        this.showDocument(arrayDocumentosFiltrados, 502, anio, mes, 'Avance de obra CCM');
        this.showDocument(arrayDocumentosFiltrados, 503, anio, mes, 'Factura de pago CCM');
        this.showDocument(arrayDocumentosFiltrados, 504, anio, mes, 'Comprobante de pago CCM');
