...
@Component({
  selector: 'app-repse-supplier-review-detail',
  templateUrl: './repse-supplier-review-detail.component.html',
  styleUrls: ['./repse-supplier-review-detail.component.css']
})
export class RepseSupplierReviewDetailComponent implements OnInit {
...
dataSourceShow : MatTableDataSource<supplierModel>
  ...
  displayedColumns = ['id', 'nombre', 'direccion', 'rfc', 'estado', 'ver', 'autorize', 'declain'];
